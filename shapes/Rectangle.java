...
/**
 * Clasa Rectangle extinde clasa Shape si contine campurile si metodele
 * specifice formei Rectangle.
 *
...
public class Rectangle extends Shape {
   ...
   * - dimensionW - dimensiunea lungimii;
   * - dimensionH - dimensiunea inaltimii;
  ...
  public Rectangle(final String nameShape, final FileReader reader)
                   throws IOException {
    super(nameShape);
    point1 = new StructPoint(reader.nextInt(), reader.nextInt());
    dimensionH = reader.nextInt();
    dimensionW = reader.nextInt();
  ...
  public final int getDimensionW() {
    return dimensionW;
  }

  public final int getDimensionH() {
    return dimensionH;
  }
